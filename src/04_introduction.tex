...
\begin{figure}[h]
    \makebox[\textwidth][c]{%
        $\vcenter{\hbox{\includegraphics[height=18mm,keepaspectratio]{img/logoNoAcc.png}}}$
        \hspace{12mm}
        {\LARGE\textbf{X}}
        \hspace{12mm}
        $\vcenter{\hbox{\includegraphics[height=26mm,keepaspectratio]{img/logoaccenture.png}}}$
    }
